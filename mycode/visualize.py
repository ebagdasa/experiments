...
def get_values():
    npa = []
    with open('/home/ubuntu/projects/mycode/snap/examples/node2vec/github.emb') as f:
        lines = f.readlines()
        dicarr = dict()
        for line in lines[1:]:
            values = line.split(' ')
...
npa = np.load('/home/ubuntu/projects/mycode/snap/examples/node2vec/nparray.npy')
